...
$string['usernametext'] = 'Username for API';
$string['usernamelongtext'] = 'Username for API';
$string['passwordtext'] = 'Password for API';
$string['passwordlongtext'] = 'Password for API';
